...
function Courses() {
    return (
        <>
            <Header />
            <section
                className="box-border leading-7 text-white bg-black border-0 border-gray-200 border-solid py-[40px] sm:py-16 md:py-16 lg:py-24 px-4" id='pricing' >
                <div className="box-border max-w-6xl px-4 pb-12 mx-auto border-solid sm:px-6 md:px-6 lg:px-4">
                    <div className="flex flex-col items-center leading-7 text-center text-white">
                        <h2
                            className="box-border m-0 text-3xl font-semibold leading-tight tracking-tight border-solid sm:text-4xl md:text-5xl">
                            Pricing Options
                        </h2>
                        <p className="box-border mt-4 text-2xl leading-normal border-solid">
                ...
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4 text-center">
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-600 px-4 py-6 cursor-pointer rounded-lg transform transition duration-500 hover:scale-110">
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-600 px-4 cursor-pointer py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
